...
namespace WebApi_A1m.Controllers
{
    ...
    {
        private readonly IProductoRopa _producto;
        public ProductoController(IProductoRopa producto) 
        {
            _producto= producto;    
        }
        [HttpGet]
        ...
        [HttpPost("agregar")]
        public IActionResult add(dbProducto obj)
        {
            _producto.Add(obj);
        ...
        [HttpPut("modificar")]
        public IActionResult put(dbProducto obj)
        {
